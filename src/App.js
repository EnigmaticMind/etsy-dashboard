...
function App() {
  return (
    <div className='App'>
                ...
                <ul className='pcoded-submenu'>
                  ...
                  <li className=''>
                    <a href='icon-feather.html' className=''>
                      Feather<span className='pcoded-badge label label-danger'>NEW</span>
                    </a>
                  </li>
                </ul>
              </li>
      ...
      {/* <!-- [ Header ] start --> */}
      <header className='navbar pcoded-header navbar-expand-lg navbar-light' style={{ display: 'none' }}>
        ...
        <div className='collapse navbar-collapse'>
          <ul className='navbar-nav mr-auto'>
            <li>
              <a href='javascript:' className='full-screen' onclick='javascript:toggleFullScreen()'>
      ...
      {/* <!-- [ Main Content ] start --> */}
      <div className='pcoded-main-container' style={{ display: 'none' }}>
                          ...
                          <div className='row d-flex align-items-center'>
                            <div className='col-9'>
                              <h3 className='f-w-300 d-flex align-items-center m-b-0'>
                                <i className='feather icon-arrow-up text-c-green f-30 m-r-10'></i>$ 249.95
                              </h3>
                            </div>
                      ...
                      <div className='card Monthly-sales'>
                        <div className='card-block'>
                          ...
                          <div className='row d-flex align-items-center'>
                            <div className='col-9'>
                              <h3 className='f-w-300 d-flex align-items-center  m-b-0'>
                                <i className='feather icon-arrow-down text-c-red f-30 m-r-10'></i>$ 2.942.32
                              </h3>
                            </div>
                            <div className='col-3 text-right'>
                      ...
                      <div className='card yearly-sales'>
                        <div className='card-block'>
                          ...
                          <div className='row d-flex align-items-center'>
                            <div className='col-9'>
                              <h3 className='f-w-300 d-flex align-items-center  m-b-0'>
                                <i className='feather icon-arrow-up text-c-green f-30 m-r-10'></i>$ 8.638.32
                              </h3>
                            </div>
                            <div className='col-3 text-right'>
                            ...
                            <table className='table table-hover'>
                              <tbody>
                                <tr className='unread'>
                                  ...
                                  <td>
                                    <h6 className='text-muted'>
                                      <i className='fas fa-circle text-c-green f-10 m-r-15'></i>11 MAY 12:56
                                    </h6>
                                  </td>
                                  <td>
                                ...
                                <tr className='unread'>
                                  ...
                                  <td>
                                    <h6 className='text-muted'>
                                      <i className='fas fa-circle text-c-red f-10 m-r-15'></i>11 MAY 10:35
                                    </h6>
                                  </td>
                                  <td>
                                    <a href='#!' className='label theme-bg2 text-white f-12'>
                                ...
                                <tr className='unread'>
                                  ...
                                  <td>
                                    <h6 className='text-muted'>
                                      <i className='fas fa-circle text-c-green f-10 m-r-15'></i>9 MAY 17:38
                                    </h6>
                                  </td>
                                  <td>
                                    <a href='#!' className='label theme-bg2 text-white f-12'>
                                ...
                                <tr className='unread'>
                                  ...
                                  <td>
                                    <h6 className='text-muted f-w-300'>
                                      <i className='fas fa-circle text-c-red f-10 m-r-15'></i>19 MAY 12:56
                                    </h6>
                                  </td>
                                  <td>
                                    <a href='#!' className='label theme-bg2 text-white f-12'>
                                ...
                                <tr className='unread'>
                                  ...
                                  <td>
                                    <h6 className='text-muted'>
                                      <i className='fas fa-circle text-c-green f-10 m-r-15'></i>21 July 12:56
                                    </h6>
                                  </td>
                                  <td>
                                    <a href='#!' className='label theme-bg2 text-white f-12'>
                          ...
                          <div className='row align-items-center justify-content-center m-b-20'>
                            <div className='col-6'>
                              <h2 className='f-w-300 d-flex align-items-center float-left m-0'>
                                4.7 <i className='fas fa-star f-10 m-l-10 text-c-yellow'></i>
                              </h2>
                            </div>
                            <div className='col-6'>
                              <h6 className='d-flex  align-items-center float-right m-0'>
                                0.4 <i className='fas fa-caret-up text-c-green f-22 m-l-10'></i>
                              </h6>
                            </div>
                          </div>
                          <div className='row'>
                            ...
                            <div className='col-xl-12'>
                              <h6 className='align-items-center float-left'>
                                <i className='fas fa-star f-10 m-r-10 text-c-yellow'></i>3
                              </h6>
                            ...
                            <div className='col-xl-12'>
                              <h6 className='align-items-center float-left'>
                                <i className='fas fa-star f-10 m-r-10 text-c-yellow'></i>1
                              </h6>
